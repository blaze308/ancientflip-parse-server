...
Parse.Cloud.beforeSave(async (request) => {
  ...
  // Apply to all your other models
  setPublicReadACL("LiveStreamingModel");
  setPublicReadACL("AudioChatUsersModel");
  setPublicReadACL("LiveViewersModel");
  setPublicReadACL("GiftsSenderModel");
  setPublicReadACL("MessageListModel");
  setPublicReadACL("GiftsModel");
  setPublicReadACL("GiftsSenderGlobalModel");
  setPublicReadACL("LeadersModel");
  setPublicReadACL("StoriesAuthorsModel");
  setPublicReadACL("ObtainedItemsModel");
  
  // Optional: More restrictive version - only authenticated users can see other users
  // Uncomment this and comment out the above if you want more privacy
  /*
